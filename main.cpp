...
// class Arcanoid {
// public:
//     Arcanoid(int w, int h): width(w), height(h), score(0), isPaused(false), isGameOver(false), isVictory(false) {
...
//     Arcanoid game(WINDOW_WIDTH, WINDOW_HEIGHT);
...
int main() {
    ...
    while (window.isOpen()) {
        ...
        game.handlePaddleInput(deltaTime);
        game.update(deltaTime);
